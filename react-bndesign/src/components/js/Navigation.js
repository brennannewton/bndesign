        ...
        <div id="reactstrap-navbar" className={`${this.state.currPage}`}>
          <Navbar collapseOnSelect expand="md" className="w-100 p-4">
            <Navbar.Brand as={Link} to="/" className="mb-auto" onClick={() => this.props.setCurrPage('Home')}>
              <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 20 17" alt="Link to the Home page">
            ...
            <Nav className="ml-auto">
              ...
              <Navbar.Collapse id="responsive-navbar-nav">
                <Nav.Link as={Link} to="music-videos" onClick={() => this.props.setCurrPage('MusicVideos')}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" viewBox="0 0 68.129 68.129" alt="Link to the Music Videos page">
                ...
                <Nav.Link as={Link} to="illustrations" onClick={() => this.props.setCurrPage('Illustrations')}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="41" height="41" viewBox="0 0 68.129 68.129" alt="Link to the Illustrations page">
                ...
                <Nav.Link as={Link} to="ux" onClick={() => this.props.setCurrPage('UX')}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 93.677 68.129" alt="Link to the User Experience page">
                ...
                <Nav.Link as={Link} to="contact" onClick={() => this.props.setCurrPage('Contact')}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="41" height="41" viewBox="0 0 68.129 68.129" alt="Link to the Contact page">
...
// Link to Paintings page:
//
// <Nav.Link as={Link} to="paintings" onClick={() => this.props.setCurrPage('Paintings')}>
//   <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" viewBox="0 0 71.913 68.129">
