            ...
            <Nav className="ml-auto">
              ...
              <Navbar.Collapse id="responsive-navbar-nav">
                <Nav.Link as={Link} to="music-videos" onClick={() => this.props.setCurrPage('MusicVideos')}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" viewBox="0 0 68.129 68.129">
                ...
                <Nav.Link as={Link} to="illustrations" onClick={() => this.props.setCurrPage('Illustrations')}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="41" height="41" viewBox="0 0 68.129 68.129">
